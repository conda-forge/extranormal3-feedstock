...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/extranormal3-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15526&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/extranormal3-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `extranormal3` can be installed with:

```
conda install extranormal3
```

It is possible to list all of the versions of `extranormal3` available on your platform with:
